...
class Product {
    ...
    init(uid : String?, name : String?, images : [UIImage]?, price : Double?, description : String?, detail : String?, relatedProductUIDs : [String]? = ["8329423-789","859659-566","658585-344","898989-213"]){
        self.name = name
        self.uid = uid
